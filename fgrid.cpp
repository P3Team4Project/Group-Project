...
void solf(double gridmax, double d){
    ...
    while (l<=max_it ){
        ...
        for (y=0;y<=H/8;y++){
            for (x=0;x<=W/8;x++){              //interpolate correction/correction/correction onto 4d grid, matching values
        ...
        for (y=0;y<=H/4;y++){
            for (x=0;x<=W/4;x++){                   //interpolate correction/correction onto 2*d grid, matching values
