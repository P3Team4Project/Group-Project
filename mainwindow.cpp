...
MainWindow::MainWindow()
{
      ...
      Vector = new QPushButton(tr("Equipotential/Field Lines"));
      ...
      QGridLayout *mainLayout = new QGridLayout;
        ...
        mainLayout->addWidget(imageDisplay2, 0, 0, 1, 4);
        ...
        mainLayout->addWidget(Vector,4,3,Qt::AlignRight );
        mainLayout->addWidget(Heat,5,3,Qt::AlignRight );
        //mainLayout->addWidget(legend,0,5,Qt::AlignRight);
...
//QPixmap pix3("./legend.jpg");
//legend->setPixmap(pix3.scaled(0.2*we,0.2*h));
