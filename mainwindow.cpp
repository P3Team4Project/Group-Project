...
MainWindow::MainWindow()
{
    ...
    //setCentralWidget(renderArea);
      ...
      CoordCheckBox = new QCheckBox(tr("Set &Coordinates?"));
            ...
            connect(Comp1, SIGNAL (released()),this, SLOT (handleButton4()));

            Comp2 = new QPushButton(tr("Comp prob2"));
            connect(Comp2, SIGNAL (released()),this, SLOT (handleButton5()));
      ...
      QGridLayout *mainLayout = new QGridLayout;
        ...
        mainLayout->addWidget(ETLabel, 3, 0, Qt::AlignRight);
        mainLayout->addWidget(ETSpinBox, 3, 1);
        ...
        mainLayout->addWidget(Comp1,4,3, Qt::AlignRight );
        mainLayout->addWidget(Comp2,5,3, Qt::AlignRight );
...
void MainWindow::Voltage()
{
    ...
    double newVoltage = VoltageSpinBox->value();
