...
MainWindow::MainWindow()
{
      ...
      connect(Comp1, SIGNAL (released()),this, SLOT (handleButton6()));

      Comp2 = new QPushButton(tr("Comp prob2"));
      connect(Comp2, SIGNAL (released()),this, SLOT (handleButton7()));
      ...
      QGridLayout *mainLayout = new QGridLayout;
        ...
        mainLayout->addWidget(ETSpinBox, 1, 3, Qt::AlignLeft);
        ...
        mainLayout->addWidget(VDisp, 4, 0);
...
void MainWindow::mouseMoveEvent(QMouseEvent *event)
{
 ...
 cout<<V[event->x()+xr][event->y()+yr]<<endl;
